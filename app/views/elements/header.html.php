...
?><div class="navbar navbar-fixed-top" >
	<div class="navbar-inner" style="width: auto; padding: 0 20px;">
		<div class="container"  style="width: 90%; padding: 0 20px;" >
			...
			<a class="brand" href="/"><img src="/img/bitcoinverified.gif" alt="BitcoinVerified.com"></a>
			...
			<?=$user['mobile']?><i class=' icon-chevron-down'></i>
			</a>
...
<header class="jumbotron subhead" id="overview">
  <div class="container" style="margin:10px">
    <h1>Bitcoin Verified</h1>
    <p class="lead">Get verified, improve your bitcoin credit score...</p>
  </div>
</header>
